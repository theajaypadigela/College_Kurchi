  ...
  if (error) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <h2 className="text-xl font-bold text-on-surface">Couldn't load the data</h2>
        <p className="text-on-surface-variant text-sm max-w-md">
          The College Kurchi dataset failed to load ({error}). This is a static site — the data
          lives in <code className="text-primary">/data/*.json</code>. Try reloading.
        </p>
        <button
